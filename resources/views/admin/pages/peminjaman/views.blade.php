      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('peminjam.create') }}" class="btn btn-primary btn-sm btn-icon-text">
                <i class="mdi mdi-plus btn-icon-prepend"></i> Tambah Peminjam
            </a>
        </div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="font-weight-bold">{{ $peminjam->nama }}</td>
                ...
                <td>
                  ...
                  <form action="{{ route('peminjam.destroy', $peminjam->id) }}" method="POST" id="delete-form-{{ $peminjam->id }}" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="{{ $peminjam->id }}" data-name="{{ $peminjam->nama }}" title="Hapus">
